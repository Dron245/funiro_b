(() => {
        ...
        if (spollersArray.length > 0) {
            ...
            if (spollersClose.length) document.addEventListener("click", (function(e) {
                ...
                if (!el.closest("[data-spollers]")) spollersClose.forEach((spollerClose => {
                    ...
                    spollersBlock.dataset.spollersSpeed && parseInt(spollersBlock.dataset.spollersSpeed);
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__body")) new core(".slider-main__body", {
        ...
        if (document.querySelector(".slider-rooms__body")) new core(".slider-rooms__body", {
            modules: [ Navigation, Pagination, Parallax ],
            navigation: {
        ...
        if (document.querySelector(".slider-tips__body")) new core(".slider-tips__body", {
            modules: [ Navigation, Pagination, Parallax ],
            navigation: {
    ...
    window.onload = function() {
        ...
        function documentaction(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                if (targetel.classList.contains("menu-header__btn")) targetel.closest(".menu-header__item").classList.toggle("_hover");
                if (!targetel.closest(".menu-header__item")) {
                    const qwwe = document.querySelectorAll(".menu-header__item");
                    for (var i = 0; i < qwwe.length; i++) qwwe[i].classList.remove("_hover");
                }
            }
            if (targetel.classList.contains("search-header__icon")) document.querySelector(".search-form").classList.toggle("_active"); else if (!targetel.closest(".search-form") && document.querySelector(".search-form._active")) document.querySelector(".search-form").classList.remove("_active");
            if (window.innerWidth < 768 && isMobile.any()) {
                if (targetel.classList.contains("menu-header__btn")) targetel.closest(".menu-header__btn").classList.toggle("_active");
                if (!targetel.closest(".menu-header__btn")) {
                    const asd = document.querySelectorAll(".menu-header__btn");
                    for (i = 0; i < asd.length; i++) asd[i].classList.remove("_active");
                }
            }
            if (window.innerWidth < 768 && isMobile.any()) if (targetel.classList.contains("footer__title")) targetel.closest(".footer__title").classList.toggle("_active");
            ...
            if (targetel.classList.contains("basket__link") || targetel.closest(".basket__link")) {
                if (document.querySelector(".cart-list").children.length > 0) document.querySelector(".actions-header__basket").classList.toggle("_active");
                e.preventDefault();
            } else if (!targetel.closest(".actions-header__basket") && !targetel.classList.contains("actions-product__button")) document.querySelector(".actions-header__basket").classList.remove("_active");
            ...
            if (targetel.classList.contains("cart-list__deleteproduct")) {
                const productId = targetel.closest(".cart-list__item").dataset.cartPid;
                e.preventDefault();
                deleteproduct(targetel, productId);
            }
            if (targetel.classList.contains("actions-header__deleteall")) {
                e.preventDefault();
                deleteAll();
            }
        }
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("_hold")) {
                ...
                const cart = document.querySelector(".basket__link");
        ...
        function updateCart(productButton, productId, productAdd = true) {
            const cart = document.querySelector(".actions-header__basket");
            ...
            if (productAdd) {
                ...
                if (!cartProduct) {
                    ...
                    if (!delet) deleteCart.insertAdjacentHTML("beforeend", `<a href="#" class=actions-header__deleteall>Delete All</a>`);
                } else {
        ...
        function deleteproduct(targetel, productId) {
            const cartProduct = document.querySelector(`[data-cart-pid="${productId}"]`);
            const cartProductQuantity = cartProduct.querySelector(".cart-list__quantity span");
            const cartQuantity = document.querySelector(".basket__link span");
        ...
        function deleteAll() {
            ...
            cartQuantity.remove();
            for (var i = 0; i < liItem.length; i++) liItem[i].remove();
            ulcart.classList.remove("_active");
        }
